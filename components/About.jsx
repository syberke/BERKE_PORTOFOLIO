        ...
        <div style={{ position: "relative", width: "100%", maxWidth: 1100, padding: "0 3rem", height: "65vh", display: "flex", alignItems: "center" }}>
          ...
          <div className="ch-1" style={{ position: "absolute", width: "100%", left: 0, padding: "0 3rem" }}>
            <div style={{ maxWidth: 700 }}>
              ...
              <h2 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: "clamp(3rem,5vw,4.2rem)", fontWeight: 600, color: "var(--text-main)", lineHeight: 1.05, marginBottom: "1.8rem" }}>
                The <em style={{ color: "var(--accent)", fontStyle: "italic" }}>Origin</em> Story
              </h2>
              <p style={{ fontFamily: "'Outfit',sans-serif", fontSize: "1.1rem", color: "var(--text-dim)", lineHeight: 1.9, marginBottom: "1.2rem" }}>
              ...
              <p style={{ fontFamily: "'Outfit',sans-serif", fontSize: "1.1rem", color: "var(--text-dim)", lineHeight: 1.9, marginBottom: "2.2rem" }}>
                Passionate about clean code, data security, and technology that creates <strong style={{ color: "var(--text-main)", fontWeight: 600 }}>real impact for communities</strong>.
              </p>
              <div style={{ display: "flex", flexWrap: "wrap", gap: ".8rem" }}>
                {[["📍", "Bekasi, Indonesia"], ["📧", "berkejaisyurrohman95@gmail.com"], ["📱", "+62 895-0614-7763"]].map(([ico, val]) => (
                  <div key={val} className="info-item" style={{ padding: "0.6rem 1.2rem", fontSize: "0.85rem" }}>
                    <div style={{ width: 28, height: 28, background: "rgba(232,163,79,0.15)", borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, color: "var(--accent)" }}>{ico}</div>
                    {val}
                  </div>
                ))}
              </div>
          ...
          <div className="ch-2" style={{ position: "absolute", width: "100%", left: 0, padding: "0 3rem", opacity: 0 }}>
            <div style={{ maxWidth: 700 }}>
              ...
              <h2 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: "clamp(3rem,5vw,4.2rem)", fontWeight: 600, color: "var(--text-main)", lineHeight: 1.05, marginBottom: "1.8rem" }}>
                My <em style={{ color: "var(--accent)", fontStyle: "italic" }}>Roots</em>
              </h2>
          ...
          <div className="ch-3" style={{ position: "absolute", width: "100%", left: 0, padding: "0 3rem", opacity: 0 }}>
            <div style={{ maxWidth: 700 }}>
              ...
              <h2 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: "clamp(3rem,5vw,4.2rem)", fontWeight: 600, color: "var(--text-main)", lineHeight: 1.05, marginBottom: "1.8rem" }}>
                The <em style={{ color: "var(--accent)", fontStyle: "italic" }}>Arsenal</em>
              </h2>
              <p style={{ fontFamily: "'Outfit',sans-serif", fontSize: "1.1rem", color: "var(--text-dim)", lineHeight: 1.9, marginBottom: "1.8rem" }}>
                My daily drivers — modern frameworks and robust backend technologies for seamless, secure digital experiences.
              </p>
          ...
          <div className="ch-4" style={{ position: "absolute", width: "100%", left: 0, padding: "0 3rem", opacity: 0 }}>
            <div style={{ maxWidth: 700 }}>
              ...
              <h2 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: "clamp(3rem,5vw,4.2rem)", fontWeight: 600, color: "var(--text-main)", lineHeight: 1.05, marginBottom: "1.8rem" }}>
                The <em style={{ color: "var(--accent)", fontStyle: "italic" }}>Philosophy</em>
              </h2>
              <p style={{ fontFamily: "'Outfit',sans-serif", fontSize: "1.1rem", color: "var(--text-dim)", lineHeight: 1.9, marginBottom: "2rem" }}>
                Technology is only as good as the mind wielding it. Clear communication, analytical thinking, and team synergy turn ideas into reality.
              </p>
